...
class GodotArrayTest {
    fun test() {
        print("Testing GDArray")
        print("--------------------------------------")
        val pool = PoolByteArray()
        pool.pushBack(10.toUByte())
        pool.pushBack(20.toUByte())
        val byteArr = GDArray(pool)
        print("Testing constructor with PoolByteArray arg: " +
        ...
        print("Testing constructor with PoolIntArray arg: " +
        ...
        realPool.pushBack(10.45)
        realPool.pushBack(20.86)
        val realArr = GDArray(realPool)
        print("Testing constructor with PoolRealArray arg: " +
        ...
        print("Testing constructor with PoolColorArray arg: " +
        ...
        print("Testing constructor with PoolVector2Array arg: " +
        ...
        print("Testing constructor with PoolVector3Array arg: " +
        ...
        print("Testing erase 1: " +
                if (arr.findLast(Variant(34)) == 3 && arr.size() == 4)
                    "OK"
                else
                    "ERROR")
        arr.erase(Variant(34))
        print("Testing erase 2: " +
